...
如果你正在使用Windows，请参考[安装Python](2.0.md)一节的内容，确保安装时勾选了`pip`和`Add python.exe to Path`。
...
![](https://cdn.liaoxuefeng.com/cdn/files/attachments/0015108290947396d54363871ae4335afeb59e4161cb7dd000/l "且慢")
